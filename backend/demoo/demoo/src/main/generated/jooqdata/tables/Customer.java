...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, String> CUSTOMER_NAME = createField(DSL.name("customer_name"), SQLDataType.VARCHAR, this, "");
     ...
     */
    public final TableField<CustomerRecord, Boolean> IS_ORGANIZATION = createField(DSL.name("is_organization"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>purchase.customer.is_person</code>.
     */
    public final TableField<CustomerRecord, Boolean> IS_PERSON = createField(DSL.name("is_person"), SQLDataType.BOOLEAN, this, "");
    ...
    public Customer customer() {
        if (_customer == null)
            _customer = new Customer(this, Keys.CUSTOMER__FK_CUSTOMER_MAIN);
