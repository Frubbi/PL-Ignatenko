...
public class Lot extends TableImpl<LotRecord> {
     ...
     */
    public final TableField<LotRecord, Long> LOT_ID = createField(DSL.name("lot_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    public Customer customer() {
        if (_customer == null)
            _customer = new Customer(this, Keys.LOT__FK_LOT_CUSTOMER);
